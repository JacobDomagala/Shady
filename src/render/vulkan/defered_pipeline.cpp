...
DeferedPipeline::SetupDescriptorSetLayout()
{
   ...
   fragmentShaderUniform.binding = 5;
   ...
   std::array< VkDescriptorSetLayoutBinding, 6 > bindings = {
      vertexShaderUniform, perInstanceBinding, positionsTexture,
      normalsTexture,      albedoTexture,      fragmentShaderUniform};
...
DeferedPipeline::SetupDescriptorSet()
{
   ...
   const auto vertexAttrubDescriptions = Vertex::getAttributeDescriptions();*/
   // Model
