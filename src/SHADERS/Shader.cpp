...
//bool
//Shader::CheckShaderStatus(uint32_t shader)
//{
...
//bool
//Shader::CheckStatus(uint32_t object, PFNGLGETSHADERIVPROC objectPropertyGetterFunc,
//                    PFNGLGETSHADERINFOLOGPROC getInfoLogFunc, uint32_t statusType)
//{
//   GLint Status;
