...
Camera::Camera(vec3 position)
  : viewDirection(0.0f, 0.0f, 0.0f), position(position),//(0.0f, 0.0f, 0.0f),
    MOVEMENT_SPEED(10.0f), velocity(0.0f, 0.0f, 0.0f), worldUp(0.0f, 1.0f, 0.0f), flyMode(false),
    speedValue(4.0f), yaw(-90.0f), pitch(0.0f), mouseSensitivity(0.55f)
{
